...
<div class="container">
	...
	<?php
		...
		<?php echo form_open_multipart('main/form_Update_common/desserts/'.$row['id']);?>
		...
		<div class="form-group">
				<input type="submit" name="upload" value="Insert" class="btn-info btn-fill active">
		</div>
		<?php
		}
		?> 
 		...
 		<table class="table table-bordered">
 			...
 			?>
 				<tr>
 					...
 					$row->id; ?>">Delete</a></td> -->
 					<td><a href="<?php echo base_url()."main/delete_data/desserts/".$row->id ;?>">Delete</a></td>
 					<td><a href="<?php echo base_url()."main/update_data/desserts/".$row->id ;?>">Update</a></td>
 				</tr>
 			<?php		
 					}
 				}else{
