                  ...
                  <div class="col-lg-11 col-xlg-11 col-md-12">
                        <div class="card">
                            <div class="card-block">
                                <?php echo form_open_multipart('main/form_Update_common/'.$row['meal_item_cat'].'/'.$row['meal_item_id']);?>
                                    <div class="form-group">
                                        <label class="col-md-12">Item Code</label>
                                        <div class="col-md-12">
                                            <input type="text" name="item_code" placeholder="Enter the item code" class="form-control form-control-line" value="<?php echo $row['meal_item_code'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="name" placeholder="Enter the Food Name" class="form-control form-control-line" value="<?php echo $row['meal_item_name'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="description" placeholder="Enter the Description" class="form-control form-control-line" value="<?php echo $row['meal_item_desc'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="price" placeholder="Enter the Price" class="form-control form-control-line" value="<?php echo $row['meal_item_price'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="item_rating" placeholder="Enter the ratings" value="<?php echo $row['meal_item_rating'] ?>" class="form-control form-control-line">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 ">
                                            <input type="file" name="file_name" class="form-control" value"<?php echo $row['meal_item_picture']?>">
                                        </div>
                                    </div>
