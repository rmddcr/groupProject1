            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <a href="AddStaff.html" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"><i class="mdi mdi-account-plus"></i> Add Food Item</a>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle">Food Items category.</h6>
          ...
          <div class="modal-dialog modal-lg">
            ...
            <div class="box">
              ...
              <div class="form-group">
                <label for="exampleFormControlFile1">Item Code</label>
                <input class="form-control" type="text" placeholder="Enter Item Code">
                    
              </div>
              <div class="form-group">
                <label for="exampleFormControlFile1">Name</label>
                <input class="form-control" type="text" placeholder="Enter Food Name">
                <span><?php echo form_error('username'); ?></span>
              </div>
              <div class="form-group">
                    <label for="inputPassword">Description</label>
                    <textarea rows="3"  class="form-control form-control-line"></textarea>
                    <span class="help-block text-muted"><small>Enter the Description about the food</small></span>
              ...
              <div class="form-group">
                    <label for="inputPassword">Ratings</label>
                    <input type="text" class="form-control" placeholder="Enter the food ratings">
                    <span><?php echo form_error('confirmpassword'); ?></span>
              </div>
