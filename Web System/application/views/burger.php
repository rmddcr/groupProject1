...
<div class="container">
	<h3>Insert Data To Burger</h3>
		...
		<?php echo form_open_multipart('main/form_Update_common/burger/'.$row['meal_item_id']);?>
		...
		<?php echo form_open_multipart('main/form_validation_food/burger');?>
		<div class="form-group">
			<label>Item_Code</label>
		...
		<div class="form-group">
			<label>Item_Category</label>
			<input type="text" name="item_category" class="form-control" value="2">
			<!-- print error message -->
			<span class="text-danger"><?php echo form_error("item_category");?></span>
		</div>
		<div class="form-group">
 		...
 		<table class="table table-bordered">
 			...
 			?>
 				<tr>
 					...
 					<td><a href="<?php echo base_url()."main/delete_data/burger/".$row->meal_item_id ;?>">Delete</a></td>
 					<td><a href="<?php echo base_url()."main/update_data/burger/".$row->meal_item_id ;?>">Update</a></td>
 				</tr>
 			<?php		
 					}
 				}else{
