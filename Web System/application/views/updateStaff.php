                  ...
                  <div class="col-lg-11 col-xlg-11 col-md-12">
                        <div class="card">
                            <div class="card-block">
                                <?php echo form_open("staff/update",'class="form-horizontal form-material"'); ?>
                                    <div class="form-group">
                                        <label class="col-md-6">ID Number</label>
                                        <div class="col-md-6">
                                            <input type="number"  class="form-control" name="idnumber" id="num" required onkeyup="checkID(); return false;" value="<?php echo $row['ID'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 ">
                                            <input type="file" name="file_name" class="form-control" value="<?php echo $row['profilepicture'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-6">Designation</label>
                                        <div class="col-md-6">
                                            <select class="form-control form-control-line" value="<?php echo $row['Designation'] ?>" name="designation">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="fullname" value="<?php echo $row['Full_Name'] ?>" required class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Gender</label>
                                        <div class="col-md-6">
                                            <select class="form-control form-control-line" name="gender" value="<?php echo $row['Gender'] ?>">
                                                <option>Male</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="date" name="dob" value="<?php echo $row['DOB'] ?>" onfocusout="validateDate();" required id="dob" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" required name="email" required class="form-control form-control-line" value="<?php echo $row['Email'] ?>" name="example-email" id="example-email">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" required name="pnumber" id="mobile" onkeyup="check(); return false;" value="<?php echo $row['Contact_number'] ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Permenant Address</label>
                                        <div class="col-md-12">
                                            <textarea rows="3" value="<?php echo $row['Address'] ?>" name="address" class="form-control form-control-line"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="3" name="quality" value="<?php echo $row['Qualification'] ?>" class="form-control form-control-line"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="3" value="<?php echo $row['Experience'] ?>" name="exper" class="form-control form-control-line"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="3" name="refer" value="<?php echo $row['Refer'] ?>" class="form-control form-control-line"></textarea>
