...
<div class="container">
	<h3>Insert Data</h3>
		...
		<form method="post" action="<?php echo base_url().'main/form_Update_common/meals/'.$row['id'];?>">
		...
		<form method="post" action="<?php echo base_url().'main/form_validation_food/meals';?>">
		<div class="form-group">
			<label>Name</label>
